...
const maptest = () => {
  ...
  const remove = (indexer) => {
    ...
    }); //*slicing array by id provided through sidebar-position, creating new array of filtered items //console.log("maptest filteredItems", filteredItems);
    ...
    /*const filteredItems = globalTrip
      .slice(0, indexer)
      .concat(globalTrip.slice(indexer + 1, globalTrip));*/ //console.log("trip:", trip);
